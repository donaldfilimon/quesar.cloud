...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DBuhKD8o.mjs");
...
var manifest = {
	"afaddab47e472f5b1d23e9ff5a5780608fab3db4d6e80f197569e2747dc035d0": {
		functionName: "loadGithub_createServerFn_handler",
		importer: () => import("./github-C0xYvn9q.mjs")
	},
	"c1aeecd732699de99d2098573d71dd95723e0fdaed88559c669cfe086ffc66fd": {
		functionName: "askPersona_createServerFn_handler",
		importer: () => import("./ai-DbE7hgie.mjs")
	},
	"cb7732b0105413784828c5e7a2458499721e084d47ddd68980d5cc45cf83139f": {
		functionName: "listNotes_createServerFn_handler",
		importer: () => import("./workspace-BEILH4Er.mjs")
	},
	"e2750a16b73a9f7b5412957e9c23dba3f04c632cc4238d2fd3b60fd411008776": {
		functionName: "deleteNote_createServerFn_handler",
		importer: () => import("./workspace-BEILH4Er.mjs")
	},
	"f9561df5a84d55cc853f86597472714c1b86c3e3e3e25e24d82a898f0bdfbfd5": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CTU_BGql.mjs").then((n) => n.t),
