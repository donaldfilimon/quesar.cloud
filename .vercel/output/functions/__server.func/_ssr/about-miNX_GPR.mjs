//#region node_modules/.nitro/vite/services/ssr/assets/about-miNX_GPR.js
var about = {
	values: [
		{
	...
	companyFacts: [
		{
			k: "Legal name",
			v: "Machine Learning Advanced Innovations, Inc."
		},
		{
			k: "Entity",
			v: "Delaware C-Corp"
		...
		{
			k: "Languages",
			v: "Zig, Swift, TypeScript"
		},
		{
			k: "Model",
			v: "SDK licensing + integration services"
		}
	],
	investorThesis: [
		{
			title: "Privacy is becoming law",
			description: "Regulated industries increasingly cannot send corpora to third-party clouds. On-device is the compliance story, not a feature."
		},
		{
			title: "The silicon is already shipped",
			description: "Apple Silicon's unified memory and Neural Engine sit idle in hundreds of millions of devices. We write the software that spends them."
		},
		{
			title: "Zero marginal cloud cost",
			description: "Local-first inference and storage carry no per-query COGS. Unit economics improve with adoption instead of degrading."
		}
	]
};
//#endregion
