...
- **Spec:** `docs/superpowers/specs/2026-09-22-mlai-merge-design.md`.
- **Checklist:** `docs/merge/gap-matrix.md`. Every row ends as `ported <sha>` or `retired: <reason>`.
...
| H | `docs/mlai/`, `sidecars/quasar-service/`, `sidecars/python-worker/`, `native/`, with provenance READMEs. |
