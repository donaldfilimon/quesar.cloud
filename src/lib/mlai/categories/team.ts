    ...
    projects: [
      {
        name: "abi",
        description:
          "An AI agent runtime paired with the WDBX substrate — high-performance local orchestration in nightly Rust, with GPU capability reporting and an MCP server. The Zig tree has been removed.",
