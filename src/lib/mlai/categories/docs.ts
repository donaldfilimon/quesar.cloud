    ...
    body: [
      {
        ...
        paragraphs: [
          "Abbey is care: empathetic, scaffolded. Aviva is clarity: concise, unfiltered. Abi is competence: the adaptive moderator that scores the blend. They are interaction roles, not separately deployed commercial services.",
      ...
      },
      {
        ...
        paragraphs: [
          "The in-browser persona router is an illustrative keyword-sentiment heuristic. The inspected local router uses deterministic rules. This is not evidence of a trained classifier, and it is not a hosted Abbey session.",
        ],
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "Storage integrity does not prove the truth of stored statements. Signatures and causal history answer why a record is trusted. Hybrid ranking currently collapses several axes into one score — that is a documented limitation, not a product claim.",
          "Reference cluster replication exists in source. It does not establish production multi-host operation.",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "There is no hosted Quesar HTTP API, no third-party SaaS SDK, and no guaranteed stable versioning across all crates. A local site-builder HTTP API exists on a trusted LAN without authentication — run it only on a network you trust.",
        ],
      },
    ],
  },
