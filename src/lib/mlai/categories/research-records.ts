...
export const researchRecords: Research = {
  tracks: [
    {
      ...
      description:
        "Understand how Abbey and ABI route requests, produce local responses, and expose bounded checks.",
      application:
    ...
    },
    {
      ...
      description:
        "Durable records, searchable vectors and inspectable retrieval for applications that need continuity.",
      application:
    ...
    },
    {
      ...
      description:
        "Select a bounded set of relevant records before assembling an assistant context.",
      application:
  ...
  publications: [
    ...
    },
    {
      ...
      status: "Implemented",
      statusNote:
        "The described source behavior is implemented; customer outcomes and deployment readiness are not established.",
      reviewedAt: "2026-09-06",
      sources: [
        {
          title: "Durable store and writer ownership",
    ...
    },
    {
      ...
      status: "Proposed",
      statusNote:
        "This is a proposed study or application pattern, not a completed experiment or deployed feature.",
      reviewedAt: "2026-09-06",
      sources: [
        {
          title: "Twelve-tool MCP contract",
