  ...
  layers: [
    {
      ...
      description:
        "CLI, terminal UI, HTTP API, and protocol surfaces (MCP, LSP, ACP). Thin adapters over the pipeline — no generation or policy logic lives here.",
    },
    {
      tier: "L5",
      title: "Orchestration",
      ...
      description:
        "Guardrails and profile routing. Abi — the adaptive, safety-aware moderator — routes each turn across the Abbey, Aviva, and Abi personas before generation begins.",
    },
    {
      tier: "L4",
      title: "Retrieval",
      ...
      description:
        "WDBX retrieval feeds generation with stored context, and the same memory search is exposed to external tools over MCP.",
    },
    {
      tier: "L3",
      title: "Acceleration",
      ...
      description:
        "Vector kernels — dot, normalize, cosine, batch cosine — on a deterministic CPU backend, with WebGPU and TPU support reported as capabilities ahead of real dispatch.",
    },
    {
      tier: "L2",
      title: "Storage",
      ...
      description:
        "The WDBX store: layered HNSW retrieval, MVCC transactions, and inspectable history. The cluster RPC transport explicitly does not implement sharding.",
    },
    {
      tier: "L1",
      title: "Audit",
      ...
      description:
        "Append-only chained block memory plus telemetry. Every pipeline turn ends by writing memory and a telemetry record, so the layers above leave receipts.",
    },
  ],
