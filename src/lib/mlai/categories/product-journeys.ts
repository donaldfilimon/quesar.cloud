...
export const productJourneys = [
  ...
  },
  {
    ...
    limitation:
      "Generation requires an available provider. Hosting, deploy adapters and authentication are outside the local v1 scope; the service listens on the LAN without authentication.",
    setupHref: "/quesar",
