  ...
  return (
    <section>
      <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
        ...
        />
        <div className="pb-1">
          <BeforeAfter value={after} onChange={setAfter} />
        </div>
      </div>

      <div
        className="relative rounded-3xl overflow-hidden"
        style={{ height: 440, background: "#050509", border: "1px solid rgba(255,255,255,0.07)" }}
      >
        ...
        {after ? (
          <>
            <div
              ...
              style={{
                background:
                  "radial-gradient(60% 50% at 50% -8%, rgba(34,211,238,0.18), transparent 70%)",
              }}
            />
            <div
              className="absolute inset-0 transition-opacity duration-700"
              style={{
                background:
                  "radial-gradient(45% 55% at 92% 108%, rgba(168,85,247,0.16), transparent 70%)",
              }}
            />
          </>
        ) : (
          <div
            ...
            style={{
              background:
                "radial-gradient(40% 40% at 20% 20%, rgba(59,130,246,0.1), transparent 60%), radial-gradient(30% 40% at 78% 38%, rgba(52,211,153,0.12), transparent 60%), radial-gradient(35% 30% at 45% 90%, rgba(251,191,36,0.1), transparent 60%)",
            }}
          />
        )}
        ...
        <div className="relative h-full flex items-center justify-center gap-5 px-8">
          {[0, 1, 2].map((i) => {
            ...
            return (
              <div
                key={i}
                className="rounded-2xl p-6 w-48 transition-all duration-700"
                style={{
                  background:
...
function CompShell({
  ...
  return (
    <div
      ...
      style={{
        background: after ? "#0b0c14" : "#0e0e15",
...
const STATS: readonly (readonly [string, string, string])[] = [
  ["1,234", "sample metric", "#22d3ee"],
  ["56%", "sample ratio", "#60a5fa"],
  ["78", "sample count", "#a855f7"],
];
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <CompShell after={after} label="Buttons">
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <button
              type="button"
              className="px-5 py-2.5 font-medium text-sm transition-all duration-500"
              style={{
                borderRadius: r,
                background: after ? "rgba(255,255,255,0.06)" : "rgba(255,255,255,0.1)",
            ...
            <button
              ...
              style={{ borderRadius: r, color: "#22d3ee" }}
            >
              Docs →
            </button>
          </div>
            ...
            {CHIPS.map(([t, c]) => (
              <span
                ...
                style={{
                  ...
                  letterSpacing: "0.1em",
                  color: after ? c : "#94a3b8",
                  background: after ? "rgba(255,255,255,0.04)" : "rgba(255,255,255,0.08)",
                  border: `1px solid ${after ? "rgba(255,255,255,0.1)" : "rgba(255,255,255,0.14)"}`,
                  fontFamily: "var(--font-mono)",
                }}
              >
                <span
                  className="w-1.5 h-1.5 rounded-full"
                  style={{ background: after ? c : "#64748b" }}
                />
                {t}
              </span>
            ))}
        ...
        <CompShell after={after} label="Feature card">
          <div
            ...
            style={{
              ...
              border: `1px solid ${after ? "rgba(255,255,255,0.09)" : "rgba(255,255,255,0.1)"}`,
              boxShadow: after
                ? "0 14px 40px rgba(0,0,0,0.45), inset 0 1px 0 rgba(255,255,255,0.08)"
          ...
          <div className="grid grid-cols-3 gap-3">
            {STATS.map(([v, l, c]) => (
              <div
                ...
                style={{
                  background: after ? "rgba(255,255,255,0.025)" : "rgba(255,255,255,0.05)",
                  border: `1px solid ${after ? "rgba(255,255,255,0.07)" : "rgba(255,255,255,0.1)"}`,
                }}
              >
                <div
                  ...
                  style={{
                    ...
                    color: after ? "#fff" : c,
                    background: after ? `linear-gradient(135deg,#fff,${c})` : "none",
                    WebkitBackgroundClip: after ? "text" : "border-box",
                    WebkitTextFillColor: after ? "transparent" : c,
                  }}
                >
                  {v}
                </div>
    ...
    <div className="relative h-full overflow-hidden" style={{ background: "#050509" }}>
      ...
      {after ? (
        <>
          <div
            ...
            style={{
              background:
                "radial-gradient(55% 45% at 50% -10%, rgba(34,211,238,0.16), transparent 70%)",
            }}
          />
          <div
            className="absolute inset-0"
            style={{
              background:
                "radial-gradient(40% 50% at 95% 110%, rgba(168,85,247,0.14), transparent 70%)",
            }}
          />
          <div
            className="absolute inset-0"
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(40% 40% at 25% 30%, rgba(59,130,246,0.12), transparent 60%), radial-gradient(35% 35% at 80% 70%, rgba(52,211,153,0.1), transparent 60%)",
          }}
        />
      )}
      ...
      <div className="relative h-full flex flex-col px-8 sm:px-14 py-8">
          ...
          <div className="hidden sm:flex items-center" style={{ gap: after ? 28 : 18 }}>
            ...
            <button
              ...
              style={{
                borderRadius: after ? 999 : 6,
                background: after ? "linear-gradient(180deg,#3b82f6,#2563eb)" : "#3b82f6",
                boxShadow: after ? "0 8px 20px -6px rgba(59,130,246,0.7)" : "none",
              }}
            >
              Request access
            </button>
        ...
        <div
          ...
          style={{ maxWidth: 760, marginTop: after ? 0 : 8 }}
        >
          <div
            className="inline-flex items-center gap-2 self-start px-3.5 py-1.5 mb-6"
            style={{
              borderRadius: after ? 999 : 6,
          ...
          <h1
            ...
            style={{
              ...
              lineHeight: after ? 1.02 : 1.12,
              letterSpacing: after ? "-0.03em" : "-0.01em",
            }}
          >
            ...
            <span
              style={
                after
                  ? {
                      background: "linear-gradient(100deg,#67e8f9,#60a5fa,#c084fc)",
        ...
        <div className="flex flex-wrap" style={{ gap: after ? 12 : 8 }}>
          {PERSONA.map((p) => (
            <div
              key={p.name}
              className="flex items-center gap-2.5 px-4 py-2.5 transition-all duration-500"
              style={{
                borderRadius: after ? 14 : 6,
                background: after
                  ? "linear-gradient(145deg,rgba(255,255,255,0.05),rgba(255,255,255,0.012))"
  ...
  return (
    <section>
      ...
      <Glass
        ...
        style={{
          background: "linear-gradient(145deg,rgba(59,130,246,0.08),rgba(168,85,247,0.05))",
        }}
      >
              ...
              const style: CSSProperties =
                tab === t
                  ? {
                      ...
                      color: "#fff",
                      boxShadow: "0 4px 14px -4px rgba(59,130,246,0.6)",
                    }
                  : {
