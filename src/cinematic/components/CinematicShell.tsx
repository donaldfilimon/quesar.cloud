...
export function CinematicShell({
  ...
  return createPortal(
    <div className="mlai-ds fixed inset-0 z-80" style={{ background }}>
      ...
      <Link
        to="/showcase"
        className="fixed top-3.5 left-3.5 z-100 flex items-center gap-2 rounded-full border border-white/15 bg-[#14141c]/80 px-4 py-2 font-mono text-[13px] tracking-[0.12em] text-white/70 backdrop-blur-md transition-colors hover:text-white"
