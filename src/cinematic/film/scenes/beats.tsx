...
export function BeatOpen() {
  ...
  const jit = released
    ? Math.sin(lt * 41) * Math.sin(lt * 6.3) * 7
    : Math.sin(lt * 30) * 2 * charge;
    ...
    <Beat>
      <DiagramSVG>
        ...
        <circle
          ...
          r={10 + charge * 26}
          fill={C.cyanHi}
          opacity={released ? shock : charge * 0.7}
          style={{ filter: `drop-shadow(0 0 ${20 + charge * 40}px ${C.cyan})` }}
        />
      </DiagramSVG>
      ...
      <div
        style={{
          ...
          left: 960,
          top: 500,
          transform: `translate(-50%,-50%) translateX(${jit}px) scale(${qScale})`,
          fontFamily: FONT.display,
          fontWeight: 800,
          fontSize: 360,
          lineHeight: 1,
          color: C.dim2,
          opacity: flick * Math.max(grow, charge * 0.4),
          textShadow: `${5 + shock * 18}px 0 rgba(248,80,80,${0.5 + shock * 0.4}), ${-(5 + shock * 18)}px 0 rgba(56,220,255,${0.5 + shock * 0.4})`,
        }}
      >
        ?
      </div>
        ...
        return (
          <div
            ...
            style={{
              ...
              background: "linear-gradient(160deg, rgba(20,20,30,0.96), rgba(8,8,14,0.96))",
              display: "flex",
              alignItems: "center",
              padding: "0 26px",
              gap: 16,
          ...
          >
            <span style={{ fontFamily: FONT.mono, fontSize: 14, color: C.dim2, width: 28 }}>
  ...
  return (
    <>
      <polygon
        ...
        fill={color}
        opacity={op * 0.5}
        style={{ filter: `drop-shadow(0 0 36px ${color})` }}
      />
      <line
        x1={x + w}
        y1={0}
  ...
  return (
    <>
      ...
      <circle
        ...
        fill={color}
        opacity={0.3}
        style={{ filter: `drop-shadow(0 0 32px ${color})` }}
      />
    </>
  );
}
    ...
    <div style={{ position: "absolute", inset: 0, opacity: op }}>
      ...
      <div
        style={{
          ...
          color: C.text,
          textShadow: `${o}px 0 rgba(248,80,80,0.6), ${-o}px 0 rgba(56,220,255,0.6)`,
        }}
      >
        {name}
      </div>
        ...
        return (
          <div
            ...
            style={{
              ...
              height: bh,
              opacity: clamp(a, 0, 1),
              transform: `translateY(${(1 - a) * 80}px) scale(${0.9 + 0.1 * a})`,
              borderRadius: 16,
              border: `1.5px solid ${c}cc`,
              background: "linear-gradient(160deg, rgba(20,20,30,0.96), rgba(8,8,14,0.96))",
              boxShadow: green ? `0 0 30px ${C.green}44` : `0 16px 40px rgba(0,0,0,0.5)`,
              padding: "18px 20px",
            }}
          >
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ fontFamily: FONT.mono, fontSize: 14, color: C.dim2 }}>
            ...
            <div style={{ marginTop: 22, fontFamily: FONT.mono, fontSize: 13, color: C.dim2 }}>
              hash
            </div>
            <div style={{ fontFamily: FONT.mono, fontSize: 22, color: green ? C.green : b[1] }}>
              {hexOf(i + 11) + "…"}
            </div>
            {green && (
              <span
        ...
        return (
          <div
            ...
            style={{
              ...
              width: cw,
              height: 140,
              opacity: clamp(on, 0, 1),
              transform: `scale(${0.6 + 0.4 * on})`,
              borderRadius: 16,
              border: `1.5px solid ${lit ? C.green + "cc" : C.line}`,
              background: lit ? `${C.green}1a` : "rgba(255,255,255,0.03)",
          ...
          >
            <span
              style={{
                ...
                background: lit ? C.green : "transparent",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                color: "#06120c",
  ...
  return (
    <Beat>
      ...
      <DiagramSVG>
        ...
        <Rotor cx={cx} cy={cy} lt={T} speed={26}>
          <circle
            cx={cx}
            cy={cy}
            r={195}
        ...
        <Rotor cx={cx} cy={cy} lt={T} speed={-18}>
          <circle
            cx={cx}
            cy={cy}
            r={320}
        ...
        return (
          <div
            ...
            style={{
              ...
              left: p.x,
              top: p.y,
              transform: `translate(-50%,-50%) scale(${0.6 + 0.4 * a})`,
              opacity: clamp(a, 0, 1),
              width: 116,
              height: 116,
              borderRadius: "50%",
      ...
      <div
        style={{
          ...
          left: cx,
          top: cy,
          transform: `translate(-50%,-50%) scale(${0.6 + 0.4 * core})`,
          opacity: clamp(core, 0, 1),
          width: 160,
          height: 160,
          borderRadius: "50%",
          border: `1.5px solid ${C.purple}cc`,
          background: `radial-gradient(circle, ${C.purple}44, rgba(10,10,16,0.96))`,
          display: "flex",
          flexDirection: "column",
          alignItems: "center",
          justifyContent: "center",
      ...
      >
        <span style={{ fontFamily: FONT.display, fontWeight: 800, fontSize: 34, color: C.text }}>
          WDBX
        </span>
        <span
          style={{ fontFamily: FONT.mono, fontSize: 13, color: C.purple, letterSpacing: "0.18em" }}
        >
          FABRIC
        </span>
      </div>
  ...
  return (
    <div
      style={{
        ...
        lineHeight: 1,
        whiteSpace: "nowrap",
        ...shimmerTextStyle(T, C.blueHi, "#ffffff", 0.35),
      }}
    >
      {word}
    </div>
      ...
      <div style={{ position: "absolute", left: 0, right: 0, top: 380, textAlign: "center" }}>
        <div
          style={{
            ...
            fontSize: 132,
            letterSpacing: "-0.03em",
            opacity: step(lt, 0, 0.6),
            ...shimmerTextStyle(T, C.blueHi, "#ffffff", 0.25),
          }}
        >
          MLAI
        </div>
    ...
    <Beat>
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "radial-gradient(60% 60% at 50% 50%, transparent, rgba(4,5,9,0.5))",
        }}
      />
      <div
        style={{
      ...
      <div
        style={{
          ...
          left: 960,
          top: 540,
          transform: `translate(-50%,-50%) scale(${0.85 + 0.15 * slam})`,
          opacity: slam,
          fontFamily: FONT.display,
          fontWeight: 800,
          fontSize: 150,
          ...
          return (
            <span
              ...
              style={{
                ...
                padding: "9px 18px",
                borderRadius: 999,
                border: `1px solid ${C.cyan}${pulse > 0.5 ? "88" : "44"}`,
                background: `${C.cyan}${pulse > 0.6 ? "1e" : "10"}`,
                fontFamily: FONT.mono,
                fontSize: 17,
                letterSpacing: "0.1em",
                color: C.cyanHi,
