    ...
    <SceneBox>
      ...
      <div
        style={{
          position: "absolute",
          left: 150,
          top: gate.y + gate.h / 2 - 46,
          width: 360,
          zIndex: 18,
          opacity: respIn,
          transform: `translateX(${(1 - respIn) * -16}px)`,
        }}
      >
        <div
          style={{
      ...
      <div
        style={{
          ...
          zIndex: 14,
          opacity: gateIn,
          transform: `translateY(${(1 - gateIn) * 18}px)`,
          borderRadius: 22,
          border: `1px solid ${C.lineHi}`,
          background: "linear-gradient(160deg, rgba(18,22,20,0.95), rgba(8,10,9,0.95))",
          boxShadow: "0 40px 100px rgba(0,0,0,0.55)",
        }}
      >
        <div style={{ padding: "22px 30px 0" }}>
          <span style={{ fontFamily: FONT.display, fontWeight: 700, fontSize: 26, color: C.text }}>
            Constitution
          </span>
        ...
        return (
          <div
            ...
            style={{
              ...
              opacity: gateIn,
              borderRadius: 12,
              border: `1px solid ${lit ? C.green + "88" : C.line}`,
              background: lit ? `${C.green}14` : "rgba(255,255,255,0.02)",
              display: "flex",
              alignItems: "center",
              gap: 10,
              padding: "0 14px",
              boxShadow: lit ? `0 0 16px ${C.green}22` : "none",
            }}
          >
            <span
              style={{
                ...
                borderRadius: "50%",
                flexShrink: 0,
                border: `1.5px solid ${lit ? C.green : C.dim2}`,
      ...
      <div
        style={{
          position: "absolute",
          left: gate.x + gate.w + 170,
          top: gate.y + gate.h / 2 - 60,
          zIndex: 20,
          opacity: passIn,
          transform: `scale(${0.8 + 0.2 * passIn})`,
    ...
    <SceneBox>
      ...
      <div
        style={{
          ...
          top: cy,
          zIndex: 18,
          transform: `translate(-50%,-50%) scale(${0.7 + 0.3 * coreIn})`,
          opacity: coreIn,
        }}
      >
        <div
          style={{
            ...
            height: 150,
            borderRadius: "50%",
            border: `1.5px solid ${C.violet}aa`,
            background: `radial-gradient(circle, ${C.violet}33, rgba(10,10,16,0.95))`,
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
            justifyContent: "center",
            boxShadow: `0 0 50px ${C.violet}55`,
          }}
        >
          <span style={{ fontFamily: FONT.display, fontWeight: 700, fontSize: 30, color: C.text }}>
            WDBX
          </span>
          <span
            style={{
        ...
        return (
          <div
            ...
            style={{
              ...
              top: p.y,
              zIndex: 16,
              transform: `translate(-50%,-50%) scale(${0.7 + 0.3 * rv})`,
              opacity: rv,
              width: 110,
              height: 110,
              borderRadius: "50%",
