  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        boxShadow: glow
          ? `0 0 60px ${C.blue}55, inset 0 0 ${size * 0.28}px rgba(255,255,255,0.22)`
          : "none",
      }}
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(120% 80% at 30% 12%, rgba(255,255,255,0.35), transparent 55%)",
        }}
      />
      <span
        style={{
  ...
  return (
    <SceneBox inDur={0.9} outDur={0.9}>
      ...
      >
        ...
        >
          <MLAIMark size={94} reveal={kicker} />
        </div>
        <div
          style={{
  ...
  return (
    <SceneBox inDur={0.7} outDur={0.7}>
      ...
      >
        ...
        >
          Today's agents are capable.
          <br />
          <span style={{ color: C.dim }}>Are they accountable?</span>
        </div>
      </div>
      ...
      >
        <span
          style={{
            ...
            fontSize: 96,
            color: C.dim2,
            opacity: qmark * (Math.sin(lt * 23) > -0.85 ? 1 : 0.3),
            lineHeight: 1,
            transform: `translateX(${Math.sin(lt * 31) * Math.sin(lt * 6) * 5}px)`,
          }}
        >
          ?
        </span>
        <span
          style={{ fontFamily: FONT.mono, fontSize: 15, letterSpacing: "0.28em", color: C.dim }}
        >
          AI&nbsp;AGENT
        </span>
      </div>
