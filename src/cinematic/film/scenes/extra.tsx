        ...
        return (
          <div
            ...
            style={{
              ...
              background: `linear-gradient(100deg, ${c}12, rgba(255,255,255,0.02))`,
              display: "flex",
              alignItems: "center",
              padding: "0 22px",
              gap: 18,
          ...
          >
            <span style={{ fontFamily: FONT.mono, fontSize: 14, color: C.dim2, width: 70 }}>
              rec {String(i).padStart(2, "0")}
            </span>
            <span style={{ flex: 1, fontFamily: FONT.mono, fontSize: 17, color: C.dim }}>
              profile={profile} · vec={hexOf(i + 3, 6)}
            </span>
            <span style={{ fontFamily: FONT.mono, fontSize: 15, color: c }}>
              crc:{hexOf(i + 20, 8)}
            </span>
            <span
              style={{
...
export function SceneTemporal() {
  ...
  return (
    <SceneBox>
      ...
      >
        score <span style={{ color: C.dim2 }}>=</span>{" "}
        <span style={{ color: C.cyan }}>semantic</span> <span style={{ color: C.dim2 }}>×</span>{" "}
        <span style={{ color: C.blueHi }}>temporal</span> <span style={{ color: C.dim2 }}>×</span>{" "}
        <span style={{ color: C.green }}>causal</span> <span style={{ color: C.dim2 }}>×</span>{" "}
        <span style={{ color: C.purple }}>persona</span>
      </div>
        ...
        return (
          <div
            ...
            style={{
              ...
              zIndex: 16,
              opacity: k,
              transform: `perspective(1000px) rotateY(${Math.sin(lt * 0.5 + i * 0.8) * 6}deg)`,
              transformOrigin: "left center",
            }}
          >
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 10 }}>
              <span style={{ fontFamily: FONT.display, fontWeight: 600, fontSize: 26, color: f.c }}>
                {f.k}
              </span>
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 7,
                  background: f.c,
                  boxShadow: `0 0 ${10 + 10 * Math.abs(Math.sin(lt * 2 + i))}px ${f.c}`,
                }}
              />
            </div>
          </div>
      ...
      <DiagramSVG>
        {RANK_FACTORS.map((f, i) => (
          <SignalPolyline
            key={i}
            pts={[
              [bx + bw + 10, by + i * (rh + rgap) + 30],
              [1360, by + i * (rh + rgap) + 30],
              [1450, 570],
            ]}
            lt={lt + i}
            count={2}
        ...
        <Rotor cx={1450} cy={570} lt={lt} speed={22}>
          <circle
            cx={1450}
            cy={570}
            r={94}
        ...
        <Rotor cx={1450} cy={570} lt={lt} speed={-14}>
          <circle
            cx={1450}
            cy={570}
            r={120}
      ...
      <div
        style={{
          ...
          height: 140,
          zIndex: 18,
          opacity: step(lt, 4, 0.8),
          transform: `scale(${1 + 0.06 * Math.sin(lt * 2.4)})`,
          borderRadius: "50%",
          border: `1.5px solid ${C.cyanHi}`,
          background: `radial-gradient(circle, ${C.cyan}33, rgba(10,10,16,0.9))`,
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          fontFamily: FONT.mono,
        ...
        return (
          <div
            ...
            style={{
              ...
              zIndex: 14,
              opacity: k,
              transform: `translateY(${(1 - k) * 36}px)`,
              borderRadius: 22,
              border: `1px solid ${p.c}55`,
              background: `linear-gradient(160deg, ${p.c}16, rgba(10,10,16,0.92))`,
              boxShadow: `0 30px 80px rgba(0,0,0,0.5), inset 0 0 40px ${p.c}0f`,
              padding: "40px 36px",
            }}
          >
            <div
              style={{
                ...
                color: p.c,
                marginBottom: 28,
                boxShadow: `0 0 30px ${p.c}44`,
              }}
            >
              {p.name[0]}
            </div>
            <div style={{ fontFamily: FONT.display, fontWeight: 700, fontSize: 44, color: C.text }}>
              {p.name}
            </div>
            <div
              style={{
...
export function SceneClaims() {
  ...
  return (
    <SceneBox>
      ...
      >
        Proposed work is labeled proposed —{" "}
        <span style={{ color: C.purple }}>never shipped as fact.</span>
      </div>
    </SceneBox>
  );
}
          ...
          <div key={i}>
            <div
              style={{
                ...
                zIndex: 16,
                borderRadius: "50%",
                background: cur ? p.c : "rgba(14,12,20,0.95)",
                border: `2px solid ${p.c}`,
                transform: `scale(${k})`,
                boxShadow: cur ? `0 0 22px ${p.c}` : "none",
              }}
            />
            <div
              style={{
                position: "absolute",
                left: px - 150,
                top: up ? lineY - 150 : lineY + 40,
                width: 300,
                textAlign: "center",
                zIndex: 14,
                opacity: k,
                transform: `translateY(${(1 - k) * (up ? -14 : 14)}px)`,
              }}
            >
              <div
                style={{
...
export function SceneManifesto() {
  ...
  return (
    <SceneBox>
      <Orb x={960} y={540} size={680} color={C.blue} opacity={0.1} />
      <DiagramSVG>
        <PulseRing
          cx={960}
          cy={540}
