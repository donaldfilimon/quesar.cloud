...
export function SceneTag({
  ...
  return (
    ...
    >
      <span
        style={{ fontFamily: FONT.mono, fontSize: 18, color: C.blueHi, letterSpacing: "0.18em" }}
      >
        {index}
      </span>
      <span
...
export function StatusBadge({
  ...
  return (
    ...
    >
      ...
      />
      {m.t}
      {note ? <span style={{ color: C.dim2, letterSpacing: "0.08em" }}>· {note}</span> : null}
    </div>
  );
}
  ...
  return (
    <div
      style={{
        ...
        background: `linear-gradient(160deg, ${accent}1a, rgba(10,10,16,0.9))`,
        display: "flex",
