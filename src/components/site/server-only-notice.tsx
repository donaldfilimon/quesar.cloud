  ...
  return (
    <div className={`mx-auto max-w-2xl rounded-lg border border-border bg-bg-elevated p-6 ${className}`} role="note">
      ...
      <p className="mt-3 text-sm leading-relaxed text-fg-muted">
        ...
        the console, admin review, profile, workspace connectors and chat need the server deployment, which is not
        live yet. Everything public on this site works as-is.
      </p>
